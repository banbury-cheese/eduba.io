...
const archiveOnlyWorkItems: WorkItem[] = [
  ...
  },
  {
    ...
    gallery: [
      { id: "iag-01", label: "INNOVATION TEAM SESSION", src: "/images/iag/01-innovation-team-session.jpeg" },
    ],
    theme: "dark",
  },
  {
  ...
  },
  {
    ...
    gallery: [
      { id: "icr-01", label: "RESEARCH ROUNDTABLE BONN", src: "/images/icr-research/01-research-roundtable-bonn.jpeg" },
    ],
    theme: "dark",
  },
  {
    ...
    gallery: [
      { id: "flagler-01", label: "EDINBURGH FUTURES INSTITUTE", src: "/images/flagler-edinburgh/01-edinburgh-futures-institute.jpeg" },
    ],
    theme: "rose",
  },
];
